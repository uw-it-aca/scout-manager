...
BUILDING_LIST = {
    ...
    "Science Building (SCI)": {"campus": "tacoma"},
    ...
    "Bothell Bookstore (LB2)": {"campus": "bothell"},
    ...
    "North Creek Events Center": {"campus": "bothell"},
    "Truly House": {"campus": "bothell"},
    "Academic Building (ADMC)": {"campus": "tacoma"},
    ...
    "University Y Student Center": {"campus": "tacoma"},
