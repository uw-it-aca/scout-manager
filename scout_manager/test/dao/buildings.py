...
TEST_BUILDING_LIST = {
    "Sea Building": {"campus": "seattle"},
    "Tac Building": {"campus": "tacoma"},
    "Bot Building": {"campus": "bothell"},
}
...
class BuildingDaoTest(TestCase):
    def test_get_all_buildings(self):
        ...
        self.assertEqual(
            ...
            {
                "Tac Building": "tacoma",
                "Sea Building": "seattle",
                "Bot Building": "bothell",
            },
        )
    ...
    def test_get_by_campus(self):
        ...
        self.assertEqual(
            (get_building_list_by_campus("tacoma")), {"Tac Building": "tacoma"}
        )
